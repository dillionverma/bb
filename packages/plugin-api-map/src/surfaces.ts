    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Implement experimental_isSuspended as a read-only provider observation; core checks suspended machines at startup and on its lifecycle sweep, serializes checks with resume/removal, and preserves and stops unexpected compute without bootstrapping",
          "Failed or interrupted resumes and failed filesystem saves remain suspending until preservation and termination succeed; core retries from the latest checkpoint without requiring a daemon connection",
